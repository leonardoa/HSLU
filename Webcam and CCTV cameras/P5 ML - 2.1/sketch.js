/*
Check body position and place image
*/
...
function draw() {
  ...
  /*
  Here we can control the images
  */
  /*
  ...
  */
  if (control == 1) {
    ...
    image(
      ...
      height / 2,
      image_width,
      (img1.height / img1.width) * image_width
    );
  } else if (control == 2) {
    /*
  ...
  */
    ...
    image(
      ...
      height / 2,
      image_width,
      (img2.height / img2.width) * image_width
    );
  } else if (control == 3) {
    /*
  ...
  */
    ...
    image(
      ...
      height / 2,
      image_width,
      (img3.height / img3.width) * image_width
    );
  } else {
    /*
